...
try {
    addressBookArray.push(new Contact("Jagan", "Palaniappan", "#jpn156", "Chennai", "TamilNadu", "600012", "91 9940698983", "ijagan.psaran38@gmail.com"));
} catch (e) {
    console.error(e);
}

try {
    addressBookArray.push(new Contact("Saravanan", "Priya", "#7ul123", "Bengaluru", "Karnataka", "456123", "91 9566266263", "Saravanan@gmail.com"));
} catch (e) {
    console.error(e);
}
